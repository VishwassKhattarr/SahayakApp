...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateAndDownloadPdf() {
        ...
        try {
            ...
            // --- CORRECTED ---
            // Clean the text to remove markdown characters
            const cleanedText = textContent.replace(/#+\s/g, '')  // Removes #, ##, ###
                                          .replace(/\*\*/g, '')   // Removes bold **
                                          .replace(/\*/g, '')    // Removes italic/bullet *
